...
##
function (n::RNNODE{M,P{FT},RE,T,A,K,F,S})(X::IT, p::AbstractArray{FT}=n.p, u₀::UT=get_u₀(X,n)) where{M<:FastRNNLayer,P,RE,T,A,K,F,S, IT<:Union{CubicSpline,CubicSplineRegularGrid},
...
function (n::RNNODE{M,P{FT},RE,T,A,K,F,S})(X::IT, ::AbstractArray{FT}=n.p, u₀::UT=get_u₀(X,n)) where {M<:FastRNNLayer,P,RE,T,A,K,F,S, IT<:Union{LinearInterpolation,LinearInterpolationRegularGrid},
  UT<:AbstractArray{<:AbstractFloat}}
...
function (n::RNNODE{M,P{FT},RE,T,A,K,F,S})(X::ConstantInterpolation, ::AbstractArray{FT}=n.p, u₀::UT=get_u₀(X,n)) where {M<:FastRNNLayer,P,RE,T,A,K,F,S, UT<:AbstractArray{<:AbstractFloat}}
...
function (n::RNNODE{M,P{FT},RE,T,A,K,F,S})(u₀::UT, ::AbstractArray{FT}=n.p) where {M<:FastRNNLayer,P,RE,T,A,K,F,S,UT<:AbstractArray{<:AbstractFloat}}
